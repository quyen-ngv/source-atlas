...
from source_atlas.lsp.multilspy.language_server import LanguageServer
from source_atlas.lsp.multilspy.lsp_protocol_handler.lsp_types import InitializeParams
from source_atlas.lsp.multilspy.lsp_protocol_handler.server import ProcessLaunchInfo
...
from source_atlas.lsp.multilspy.multilspy_settings import MultilspySettings
from source_atlas.lsp.multilspy.multilspy_utils import FileUtils
from source_atlas.lsp.multilspy.multilspy_utils import PlatformUtils
...
class EclipseJDTLS(LanguageServer):
    ...
    async def start_server(self) -> AsyncIterator["EclipseJDTLS"]:
        ...
        async with super().start_server():
            ...
            self.logger.log(
                "Sending initialize request from source_atlas.lsp client to LSP server and awaiting response",
                logging.INFO,
            )
